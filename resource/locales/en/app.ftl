...
model_undo = Undo
model_redo = Redo
model_storage_file = Rows live in { $file } — each edit folds to SQL at the turn's end
...
query_fts = Full-text (FTS5)
query_viewport = Viewport only
query_viewport_box = lat { $from }–{ $to }
query_star = Toggle Star
...
canvas_interaction_title = Tap, drag & hover
canvas_interaction_label = Reported
canvas_interaction_none = —
canvas_interaction_readout = hover { $hover } · tap { $tap } · drag { $trail } points
...
http_caps = Capabilities
stream_title = Streaming
stream_start = Stream a slow response
download_title = Download manager
download_start = Start
download_pause = Pause
download_resume = Resume
download_cancel = Cancel
download_detail = { $received } of { $total } · { $rate } · { $remaining } left
download_resumed = Resumed at { $offset }
download_verified = SHA-256 verified
download_system = Let the system run it
download_tier_app = In the app
download_tier_system = By the system
upload_title = Uploads
upload_stream = Upload 8 MiB
upload_form = Upload a form
upload_digest_match = SHA-256 matches
upload_digest_mismatch = SHA-256 differs
redirect_title = Redirects
redirect_follow = Follow three redirects
redirect_stop = Stop at the first
...
cookie_send = Send cookies
cookie_clear = Clear cookies
cookie_store_platform = Cookies stay in the platform's cookie store.
cookie_store_jar = Cookies stay in the client's own jar.
cache_title = Cache
cache_fetch = Fetch
cache_reload = Reload
...
ws_ping = Ping
ws_close = Close
timeout_title = Time limits
timeout_run = Wait three seconds with a one-second limit
trust_title = Server trust
trust_visit = Visit a self-signed server
trust_accept = Trust it anyway
trust_pins = Check public-key pins
identity_without = Connect without a certificate
identity_with = Connect with a certificate
...
speech_state_speaking = Speaking…
speech_state_finished = Finished
speech_state_stopped = Stopped
