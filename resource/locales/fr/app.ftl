...
model_undo = Annuler
model_redo = Rétablir
model_storage_file = Les lignes vivent dans { $file } — chaque modification devient du SQL en fin de tour
...
query_fts = Texte intégral (FTS5)
query_viewport = Fenêtre uniquement
query_viewport_box = lat { $from }–{ $to }
query_star = Basculer le favori
...
canvas_interaction_title = Toucher, glisser et survoler
canvas_interaction_label = Signalé
canvas_interaction_none = —
canvas_interaction_readout = survol { $hover } · touche { $tap } · glissement { $trail } points
...
http_caps = Capacités
stream_title = Flux
stream_start = Diffuser une réponse lente
download_title = Gestionnaire de téléchargements
download_start = Démarrer
download_pause = Pause
download_resume = Reprendre
download_cancel = Annuler
download_detail = { $received } sur { $total } · { $rate } · reste { $remaining }
download_resumed = Repris à { $offset }
download_verified = SHA-256 vérifié
download_system = Confier au système
download_tier_app = Dans l'app
download_tier_system = Par le système
upload_title = Envois
upload_stream = Envoyer 8 Mio
upload_form = Envoyer un formulaire
upload_digest_match = Le SHA-256 correspond
upload_digest_mismatch = Le SHA-256 diffère
redirect_title = Redirections
redirect_follow = Suivre trois redirections
redirect_stop = S'arrêter à la première
...
cookie_set = Déposer un cookie
cookie_send = Envoyer les cookies
cookie_clear = Effacer les cookies
cookie_store_platform = Les cookies restent dans le magasin de cookies de la plateforme.
cookie_store_jar = Les cookies restent dans la réserve du client.
cache_title = Cache
cache_fetch = Récupérer
cache_reload = Recharger
cache_clear = Vider le cache
ws_title = WebSocket
ws_connect = Se connecter
ws_send = Envoyer
ws_ping = Ping
ws_close = Fermer
timeout_title = Délais
timeout_run = Attendre trois secondes avec une limite d'une seconde
trust_title = Confiance dans le serveur
trust_visit = Visiter un serveur auto-signé
trust_accept = Lui faire confiance
trust_pins = Vérifier les empreintes de clé publique
identity_without = Se connecter sans certificat
identity_with = Se connecter avec un certificat
...
speech_state_speaking = Lecture en cours…
speech_state_finished = Terminé
speech_state_stopped = Arrêté
